...
import javax.swing.table.DefaultTableModel;
	...
	public class ViewTransactionAdmin extends JInternalFrame {
	...
	private final JLabel lbDate = new JLabel("");
	...
	public ViewTransactionAdmin() {
		...
		lbTotal.setLocation(194,135);
		lbTotal.setSize(114,21);
		
		lbDate.setLocation(194,107);
		...
		txtUsername.setLocation(48, 79);
		txtUsername.setSize(94, 21);
		getContentPane().add(txtUsername);
		lbUsername.setFont(new Font("Tahoma", Font.BOLD, 12));
		
		lbUsername.setLocation(194, 82);
		lbUsername.setSize(114, 21);
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ViewTransactionAdmin frame = new ViewTransactionAdmin();
